...
import { ListPositionCacheEntry, PositionCache } from './drop-list';
 ...
 * @docs-private
 */
export const CDK_DROP_PARENT = new InjectionToken<{ stopDragOver: () => void, startDragOver: () => void }>('CDK_DROP_PARENT');
